      ...
      <div class="page">
        ...
        <div class="view">
          ...
          <div class="money-box bg-box">
            <div class="totalMoney">总资产(USDT)</div>
            <div class="totalUsdt">
              <span>51.88</span>
              <i class="reload" />
            </div>
  ...
  .money-box {
    ...
    .totalUsdt {
      ...
      &:before {
        ...
        height: 1rem;
        content: "";
        background: url(data:image/png;base64,) no-repeat;
