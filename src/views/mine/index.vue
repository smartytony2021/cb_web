          ...
          <div class="mine-info-box">
            ...
            <div class="assets-box">
              <div class="bg-box">
                ...
                <div class="assetsAdd">
                  <div class="val">TDJJqGNpkZpSioBegZM8yyq1K7YnZA17nu</div>
                  <button>复制</button>
                </div>
                <div class="money flex-between-center">
                  <div class="title">USDT:<span>0.00</span></div>
                  <div class="title">TRX:<span>0.00</span></div>
                </div>
              </div>
            </div>
            <!-- 资产 - end -->
...
.page {
  ...
  .mine-info-box {
    padding: 4.125rem 0.625rem 0 0.625rem;
    ...
    .assets-box {
      ...
      .assetsAdd {
        display: flex;
        background: #e7e7e7;
        box-shadow: 0 0.0625rem 0 #fff, inset 0 0.0625rem 0 rgb(0 0 0 / 12%);
